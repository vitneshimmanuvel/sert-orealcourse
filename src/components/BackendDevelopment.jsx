    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-blue-500 pl-4">Course Introduction</h2>
        ...
        {/* Prerequisites */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-blue-500 pl-4">Pre-requisites</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-purple-700">Recommended</h3>
        ...
        {/* Modules */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-blue-500 pl-4">Course Modules</h2>
        ...
        {/* Outcomes */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-blue-500 pl-4">Learning Outcomes</h2>
        ...
        {/* Certification */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-blue-500 pl-4">Certification</h2>
      ...
      <footer className="bg-gradient-to-r from-blue-900 to-purple-800 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <p className="mt-2 text-purple-200">Master the server-side of web applications</p>
          </div>
        </div>
      </footer>
    </div>

  ...
  const modules = [
    {
      ...
      objective: "Understand the basics of graphic design and its importance in visual communication.",
      topics: [
        "What is graphic design?",
        "Elements and principles of design",
        "History of graphic design",
        "Key terms: Typography, Composition, Balance"
      ]
    },
    {
      title: "Tools of Graphic Design",
      objective: "Explore the tools used in graphic design to create visually appealing content.",
      topics: [
        "Introduction to Canva, Adobe Illustrator, and Photoshop",
        "Basics of image editing and manipulation",
        "Color theory and typography basics",
        "Designing logos, banners, and brochures"
      ]
    },
    {
      title: "Design Principles",
      objective: "Understand and apply fundamental design principles to create professional-grade graphics.",
      topics: [
        "Contrast, alignment, repetition, proximity",
        "Balance, hierarchy, and emphasis in design",
        "Creating effective visual compositions",
        "Layout and grids in design"
      ]
    },
    {
      title: "Design Tools Practice",
      objective: "Gain hands-on experience with design tools to create professional-grade graphics.",
      topics: [
        "Creating digital illustrations and vector designs",
        "Using Canva for creating social media posts",
        "Adobe Photoshop basics for image manipulation",
        "Exporting graphics for print and digital"
      ]
    },
    {
      title: "Advanced Graphic Design Techniques",
      objective: "Explore advanced techniques to enhance graphic designs and create polished visuals.",
      topics: [
        "Creating and editing artwork using advanced tools",
        "Typography and layout design",
        "Advanced color correction techniques",
        "Designing for different platforms (web, print, mobile)"
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              Graphic design involves visual communication through images, typography, and layout to deliver messages effectively. 
              This course introduces essential graphic design principles, tools, and techniques to help you create stunning visuals 
              for print and digital media.
            </p>
            <p className="text-lg">
              By mastering key tools and design principles, you will be able to create compelling visuals for diverse media. 
              This course will empower you with the skills necessary to pursue a career in graphic design or offer creative solutions as a freelancer.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">No prior knowledge required, but basic creativity helps</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-emerald-700">Helpful</h3>
              <p className="text-lg">Familiarity with basic image editing tools will be helpful</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Proficiency in graphic design tools</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Ability to create engaging and visually appealing content</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Understanding design principles and composition</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Designing logos, banners, brochures, and other marketing materials</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Work on real-world graphic design projects</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Print Media Designer</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-6">
                Upon completing this Graphic Design Mastery course, you will receive a globally recognized certification.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Expertise in graphic design and visual communication</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Ability to work on real-world design projects</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your Graphic Design Journey Today</h2>

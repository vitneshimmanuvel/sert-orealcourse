    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-orange-50 text-gray-800">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6 flex-1">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-baseline">
                  <span className="text-2xl font-bold mr-2">CAD 200</span>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-red-500 pl-4">Course Introduction</h2>
        ...
        {/* Prerequisites */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-red-500 pl-4">Pre-requisites</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-orange-700">Required</h3>
              <p className="text-lg">No prior art experience needed</p>
            </div>
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-red-700">Helpful</h3>
        ...
        {/* Modules */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-red-500 pl-4">Course Modules</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Module Navigation */}
            <div className="lg:col-span-1 bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-xl font-semibold mb-4 text-red-700">Module Overview</h3>
              ...
              <ul className="space-y-3">
                {modules[activeModule].topics.map((topic, index) => (
                  <li key={index} className="flex items-start">
                    <span className="inline-block mt-1.5 w-5 h-5 rounded-full bg-red-500 mr-3 flex-shrink-0"></span>
        ...
        {/* Outcomes */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-red-500 pl-4">Learning Outcomes</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-4 text-orange-700">Course Outcomes</h3>
              <ul className="space-y-3">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-4 text-red-700">Career Opportunities</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3 text-red-700">Entrepreneurial Opportunities</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
        ...
        {/* Certification */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 border-l-4 border-red-500 pl-4">Certification</h2>
          
          <div className="bg-gradient-to-r from-orange-600 to-red-700 text-white rounded-xl p-8 shadow-xl">
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="bg-gradient-to-r from-red-500 to-red-600 text-white font-bold px-8 py-4 rounded-full text-lg hover:from-red-600 hover:to-red-700 transition-all shadow-lg hover:shadow-xl"
            >
              Enroll Now 
            </button>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <div className="bg-gradient-to-br from-yellow-400 to-red-500 rounded-full w-16 h-16 flex items-center justify-center">
                <span className="text-2xl font-bold">C</span>
              </div>
            </div>
            <p className="text-lg">© 2025 settlo academy all rights reserved.</p>
            <p className="mt-2 text-orange-200">Designed for creative expression</p>
          </div>
        </div>
      </footer>
    </div>

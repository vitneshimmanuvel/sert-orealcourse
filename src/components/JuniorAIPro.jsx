...
const JuniorAIPro = () => {
      ...
      try {
        const response = await fetch('https://settlo-forms-notlead.onrender.com/api/course-enrollment', {
          ...
          body: JSON.stringify({
            ...
            courseName: 'Junior AIPro – Artificial Intelligence for Kids',
          }),
        });
  ...
  const modules = [
    {
      title: "What is AI?",
      objective: "Understand the basics of AI and how it works in our daily lives",
      topics: [
        "Everyday AI Around You",
        "Intro to Machine Learning"
      ]
    },
    {
      title: "Learning AI Tools",
      objective: "Explore AI tools that allow kids to train their own models",
      topics: [
        "Teachable Machine (Train Your Model)",
        "Using Pre-built Models"
      ]
    },
    {
      title: "Code-Free AI Projects",
      objective: "Create interactive projects using drag-and-drop interfaces",
      topics: [
        "Creating Games that Recognize Faces or Sounds",
        "Add Logic with Drag-and-Drop Blocks"
      ]
    },
    {
      title: "AI Mini Projects",
      objective: "Build complete AI-powered applications from start to finish",
      topics: [
        "Build a Smart Quiz App",
        "Build a Reaction Game with AI"
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      <header className="text-black py-16 px-4">  
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Junior AIPro – Artificial Intelligence for Kids</h1>
              <p className="text-xl max-w-3xl">
                A simple and exciting course designed to introduce AI to kids using drag-and-drop tools like FlutterFlow and Google Teachable Machine
              </p>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-1">
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              Junior AIPro is a simple and exciting course designed to introduce AI to kids using drag-and-drop tools like FlutterFlow, Google Teachable Machine, and fun logic-based platforms. 
              Kids will build interactive projects and games that react using simple AI logic.
            </p>
            <p className="text-lg">
              This course is perfect for children aged 10+ who want to develop their curiosity about AI and learn basic concepts in a playful and engaging environment.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">Basic curiosity and love for puzzles or games</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Understand what AI is and how it works</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Interact with real-world AI tools</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Build creative logic-based projects</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Kids will gain basic AI literacy</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Encourages curiosity and analytical thinking</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Build a strong foundation for future STEM learning</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">AI Explorer Certificate</h3>
              <p className="text-xl mb-6">
                Upon completing this Junior AIPro course, kids will receive an AI Explorer Certificate of Completion.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Certificate of AI Exploration</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Access to pre-built game templates for fun experiments</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your Kid's AI Journey Today</h2>
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            Unlock your child's curiosity about AI with our fun and engaging course
          </p>

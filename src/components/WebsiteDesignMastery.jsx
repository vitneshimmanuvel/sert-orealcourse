      ...
      try {
        const response = await fetch('https://settlo-forms-notlead.onrender.com/api/course-enrollment', {
          ...
          body: JSON.stringify({
            ...
            courseName: 'Website Design Mastery',
          }),
        });
  ...
  const modules = [
    {
      ...
      objective: "Understand the basics of website design and the importance of creating functional websites.",
      topics: [
        "What is website design?",
        "Principles of effective web design",
        "Key terms: UI, UX, Responsive Design",
        "Introduction to front-end vs. back-end development"
      ]
    },
    {
      title: "Tools and Technologies in Web Design",
      objective: "Explore tools and technologies used in web design to build responsive websites.",
      topics: [
        "Introduction to web design tools (Adobe XD, Figma, WordPress & Weebly)",
        "HTML & CSS/WordPress, Weebly - fundamentals",
        "Frameworks (Bootstrap)",
        "Basics of WordPress for web design"
      ]
    },
    {
      title: "UI/UX Design Fundamentals",
      objective: "Learn the principles of UI/UX design and how to create visually appealing web interfaces.",
      topics: [
    ...
    },
    {
      ...
      objective: "Gain hands-on experience in designing responsive websites that work on all devices.",
      topics: [
        "Creating responsive web designs using CSS / WordPress, Weebly",
        "Implementing flexible grid systems",
        "Media queries and adaptive design",
        "Designing websites for mobile and desktop"
      ]
    },
    {
      title: "Advanced Web Design Techniques",
      objective: "Master advanced web design techniques and tools for creating sophisticated websites.",
      topics: [
        "Advanced Website techniques",
        "Using WordPress, Weebly",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      <header className="text-black py-16 px-4">  
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Website Design Mastery</h1>
              <p className="text-xl max-w-3xl">
                Transform your creative vision into stunning websites with our intensive 1-month program
              </p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-blue-600 rounded-lg p-6 flex-1">
              ...
              <ul className="space-y-1">
                <li className="flex items-center">
                  <span className="mr-2">•</span> 4 weeks of hands-on learning
                </li>
                <li className="flex items-center">
      ...
      <main className="max-w-6xl mx-auto px-4 py-1">
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              Website design is the process of creating visually appealing and functional websites that offer a seamless user experience. 
              This course covers the basics of web design, front-end development, and how to build responsive websites using modern tools and frameworks.
            </p>
            <p className="text-lg">
              By mastering key design principles and development techniques, you will be able to create engaging websites for diverse platforms. 
              This course will empower you with the skills necessary to pursue a career in web design or offer creative solutions as a freelancer.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">Basic understanding of HTML, CSS or any Wordpress & Weebly helpful but not mandatory</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-emerald-700">Helpful</h3>
              <p className="text-lg">Creativity and logical thinking</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Proficiency in website design tools</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Ability to create responsive and functional websites</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Understanding UI/UX principles for web design</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Designing websites using HTML, CSS or WordPress, Weebly</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Work on real-world web design projects</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Web Design Consultant</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-6">
                Upon completing this Website Design Mastery course, you will receive a globally recognized certification.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Expertise in web design and front-end development</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Ability to work on real-world web projects</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your Website Design Journey Today</h2>
...
export default WebsiteDesignMastery;
...
const TextileDesigningMastery = () => {
      ...
      try {
        const response = await fetch('https://settlo-forms-notlead.onrender.com/api/course-enrollment', {
          ...
          body: JSON.stringify({
            ...
            courseName: 'Textile Designing Mastery',
          }),
        });
  ...
  const modules = [
    {
      title: "Introduction to Textile Design",
      objective: "Understand the basics of textile design and its importance in various industries.",
      topics: [
        "What is textile design?",
        "History and evolution of textile design",
        "Types of textiles (woven, knitted, printed)",
        "Key terms: Weaving, Dyeing, Printing"
      ]
    },
    {
      title: "Tools and Techniques in Textile Design",
      objective: "Explore tools and techniques used in textile design for creating fabrics and patterns.",
      topics: [
        "Introduction to textile design software (Adobe Illustrator, CorelDRAW)",
        "Fabric printing techniques (screen printing, digital printing)",
        "Basics of textile weaving and knitting",
        "Introduction to yarns, fibers, and threads"
      ]
    },
    {
      title: "Color and Pattern in Textile Design",
      objective: "Learn the principles of color theory and how to create patterns for textiles.",
      topics: [
        "Color theory and its application in textile design",
        "Creating repeat patterns and motifs",
        "Digital textile printing techniques",
        "Color management in textile design",
        "Simple package designing"
      ]
    },
    {
      title: "Designing for Different Textiles",
      objective: "Gain hands-on experience in designing textiles for various applications.",
      topics: [
        "Designing patterns for apparel",
        "Creating textiles for interior décor",
        "Textile design for lifestyle products",
        "Textile design for home furnishings"
      ]
    },
    {
      title: "Advanced Techniques in Textile Design",
      objective: "Master advanced techniques and tools to create high-quality textile designs.",
      topics: [
        "Advanced color blending techniques",
        "Textile design using advanced software",
        "Customizing and personalizing textile patterns",
        "Creating sustainable textile designs"
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      <header className="text-black py-16 px-4">  
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Textile Designing Mastery</h1>
              <p className="text-xl max-w-3xl">
                Transform your creative vision into stunning textiles with our intensive 1-month program
              </p>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-1">
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              Textile design is a creative process that blends art, science, and technology to create fabrics and patterns. 
              This course covers textile design fundamentals, color theory, printing techniques, and pattern development. 
              Learn to design textiles for apparel, interiors, and lifestyle products.
            </p>
            <p className="text-lg">
              By mastering key tools and fabric creation techniques, you will be able to create compelling textile designs for diverse applications. 
              This course will empower you with the skills necessary to pursue a career in textile design or offer creative solutions as a freelancer.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">No prior knowledge required, beginners welcome</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-emerald-700">Helpful</h3>
              <p className="text-lg">Creativity and interest in textiles are helpful</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Proficiency in textile design software</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Ability to create and design textile patterns</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Understanding textile printing and weaving techniques</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Designing textiles for apparel, interiors, and lifestyle products</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Work on real-world textile design projects</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Surface Pattern Designer</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Apparel Designer</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Fabric Artist</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-6">
                Upon completing this Textile Designing Mastery course, you will receive a globally recognized certification.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Expertise in textile design and pattern making</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Ability to work on real-world textile projects</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your Textile Design Journey Today</h2>
...
export default TextileDesigningMastery;
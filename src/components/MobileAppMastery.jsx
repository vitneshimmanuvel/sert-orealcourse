      ...
      try {
        const response = await fetch('https://settlo-forms-notlead.onrender.com/api/course-enrollment', {
          ...
          body: JSON.stringify({
            ...
            courseName: 'Mobile Application Mastery',
          }),
        });
  ...
  const modules = [
    {
      ...
      objective: "Introduce the basics of mobile app development and the tools used.",
      topics: [
    ...
    },
    {
      ...
      objective: "Learn the fundamentals of Flutter, a powerful cross-platform development tool.",
      topics: [
        "Installing Flutter and IDE setup",
        "Understanding the Dart programming language",
        "Creating basic widgets and layouts",
        "Navigation and state management"
      ]
    },
    {
      title: "UI Design and Material Design",
      objective: "Build responsive and engaging UI for mobile apps using Flutter’s material design.",
      topics: [
        "Widgets and building responsive UI",
    ...
    },
    {
      ...
      objective: "Learn how to handle data operations in mobile applications.",
      topics: [
        "Fetching data from APIs",
        "Using SQLite for local data storage",
        "Managing state with streams and providers",
        "Performing CRUD operations"
      ]
    },
    {
      title: "Building a Complete Mobile Application",
      objective: "Apply all learning to develop a fully functional mobile application.",
      topics: [
        "Designing the app architecture",
        "Integrating APIs and backend services",
        "Testing and debugging Flutter apps",
        "Deploying mobile applications to app stores"
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
          ...
          <div className="flex flex-col md:flex-row items-center mb-8">
            ...
            <div>
              ...
              <p className="text-xl max-w-3xl">
                Learn to build powerful cross-platform mobile applications with Flutter
              </p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-blue-600 rounded-lg p-6 flex-1">
              ...
              <ul className="space-y-1">
                <li className="flex items-center">
                  <span className="mr-2">•</span> 4 weeks of practical learning
                </li>
                <li className="flex items-center">
                  <span className="mr-2">•</span> 6 live sessions
                </li>
                <li className="flex items-center">
      ...
      <main className="max-w-6xl mx-auto px-4 py-1">
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              Mobile applications have become an essential part of daily life. This course provides a deep understanding of mobile app development using Flutter, one of the most popular cross-platform development frameworks. You will learn to build engaging, responsive, and scalable mobile applications for Android and iOS.
            </p>
            <p className="text-lg">
              By mastering Flutter and Dart, you will be able to create cross-platform mobile applications that work seamlessly on both Android and iOS platforms. This course will empower you with the skills necessary to pursue a career in mobile application development or offer creative solutions as a freelancer.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">Basic understanding of programming (any language)</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-emerald-700">Helpful</h3>
              <p className="text-lg">Familiarity with basic UI/UX design principles</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Mastery of Flutter and Dart for mobile app development</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Proficiency in creating responsive mobile applications</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Ability to integrate APIs and databases into mobile apps</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Skills in deploying mobile applications to app stores</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Understanding of UI/UX best practices for mobile design</span>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-6">
                Upon completion, you will receive a certification that validates your mobile application development skills using Flutter.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Expertise in cross-platform mobile app development</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Proficiency in Flutter and Dart programming language</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Ability to develop API-integrated mobile applications</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Early access to new courses and special promotions</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your Mobile App Development Journey Today</h2>
...
export default MobileAppMastery;
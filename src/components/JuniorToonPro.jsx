...
const JuniorToonPro = () => {
      ...
      try {
        const response = await fetch('https://settlo-forms-notlead.onrender.com/api/course-enrollment', {
          ...
          body: JSON.stringify({
            ...
            courseName: 'Junior ToonPro – Cartoon Design for Kids',
          }),
        });
  ...
  const modules = [
    {
      title: "Intro to Cartoons and Characters",
      objective: "Understand the basics of cartoons and character design",
      topics: [
        "What are Cartoons?",
        "Basic Shapes and Character Expressions"
      ]
    },
    {
      title: "Digital Drawing Tools",
      objective: "Learn to use digital tools for cartoon drawing",
      topics: [
        "Using Sketchbook for Drawing",
        "Exploring Brushes, Layers, and Colors"
      ]
    },
    {
      title: "Create Your Own Comic Strip",
      objective: "Explore comic storytelling and panel creation",
      topics: [
        "Learn Comic Storytelling Basics",
        "Using Pixton to Build Comic Panels"
      ]
    },
    {
      title: "Cartoon Project",
      objective: "Complete a comprehensive cartoon project",
      topics: [
        "Create a 3-Page Digital Comic Book",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      <header className="text-black py-16 px-4">  
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Junior ToonPro – Cartoon Design for Kids</h1>
              <p className="text-xl max-w-3xl">
                A creative course where kids learn cartoon drawing, character creation, and digital comic making using tools like Sketchbook and Pixton
              </p>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-1">
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              Junior ToonPro is a creative and playful course where kids learn the basics of cartoon drawing, character creation, and digital comic making. 
              Using tools like Sketchbook and Pixton, children explore storytelling through their own cartoon characters and illustrations.
            </p>
            <p className="text-lg">
              This course is perfect for children aged 10+ who want to develop their drawing skills and learn basic storytelling concepts in a fun and engaging environment.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">Interest in drawing or animated stories</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Develop cartooning and storytelling skills</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Learn how to use digital illustration tools</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Create complete comic strips and short stories</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Kids will build confidence in their drawing abilities</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Gain storytelling and design skills</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Start a portfolio for future creative pursuits</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">Cartoon Design Certificate</h3>
              <p className="text-xl mb-6">
                Upon completing this Junior ToonPro course, kids will receive a Certificate of Completion in Cartoon Design.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Access to digital cartoon templates and props</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Golden Membership for next creative course</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your Kid's Cartoon Journey Today</h2>
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            Unlock your child's creativity with our fun and engaging cartoon design course
          </p>

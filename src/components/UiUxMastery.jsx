  ...
  const modules = [
    {
      ...
      objective: "Understand the foundational principles of UI UX design and the role it plays in product development.",
      topics: [
        "What is UI/UX?",
        "Importance of UI UX in software development",
        "Key terms: Wireframing, Prototyping, Usability testing",
        "UI vs. UX – Understanding the difference"
      ]
    },
    {
      title: "UI Design Fundamentals",
      objective: "Learn the basic elements of UI design and principles for creating visually engaging interfaces.",
      topics: [
        "Basics of color theory and typography",
        "UI design best practices",
        "Design principles (alignment, hierarchy, contrast)",
        "Creating wireframes using tools like Figma and Adobe XD"
      ]
    },
    {
      title: "UX Design Fundamentals",
      objective: "Dive deep into UX design methodologies and how to create user-centric experiences.",
      topics: [
        "User research techniques (interviews, surveys, user personas)",
        "User journey mapping",
        "Information Architecture (IA)",
        "Prototyping with tools like Sketch and InVision"
      ]
    },
    {
      title: "UI Prototyping",
      objective: "Gain hands-on experience in prototyping to create interactive designs.",
      topics: [
        "Introduction to prototyping",
        "Creating high-fidelity prototypes using Figma and Adobe XD",
    ...
    },
    {
      ...
      objective: "Explore advanced tools and techniques to enhance UI UX design.",
      topics: [
        "Advanced features of Figma and Adobe XD",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      <header className="text-black py-16 px-4">  
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">UI UX MASTERY</h1>
              <p className="text-xl max-w-3xl">
                Design intuitive and engaging digital experiences with our comprehensive 2-month program
              </p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-blue-600 rounded-lg p-6 flex-1">
              ...
              <ul className="space-y-1">
                <li className="flex items-center">
                  <span className="mr-2">•</span> 8 weeks of in-depth learning
                </li>
                <li className="flex items-center">
      ...
      <main className="max-w-6xl mx-auto px-4 py-1">
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-lg mb-4">
              UI/UX design focuses on creating intuitive and visually appealing user interfaces for software and applications. 
              This course delves into the principles of User Interface (UI) and User Experience (UX) design, user research, 
              wireframing, prototyping, and designing seamless user journeys.
            </p>
            <p className="text-lg">
              By mastering design tools and methodologies, you will be prepared to work in various industries where user 
              interface design is crucial. This course provides comprehensive training to design engaging and user-centric 
              digital experiences.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-lg">Basic understanding of graphic design</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold mb-3 text-emerald-700">Helpful</h3>
              <p className="text-lg">Familiarity with design tools like Canva or Adobe XD will be helpful</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Proficiency in UI and UX design</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Ability to conduct user research and create personas</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Proficiency in wireframing, prototyping, and usability testing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Design intuitive user interfaces for web and mobile applications</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-500 mr-2">✓</span>
                  <span>Work on real-world UI/UX projects</span>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-emerald-800 text-white rounded-xl p-8 shadow-xl">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-6">
                Let Your Certificate Speak – You will receive a recognized certification upon successful course completion.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Expertise in UI UX design and user-centric thinking</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
                      <span>Ability to create engaging digital experiences</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">★</span>
        ...
        <section className="text-center py-12 px-4 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-4">Start Your UI UX Journey Today</h2>
